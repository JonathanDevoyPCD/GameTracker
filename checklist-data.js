      ...
      "sections": [
        {
          ...
          "tasks": [
            { "id": "p1-anim-001", "title": "Import or add the Game Animation Sample to the project", "description": "Bring Epic's Game Animation Sample into the Unreal project carefully, ideally after a backup or clean commit so imported assets can be reviewed safely.", "status": "Complete" },
            { "id": "p1-anim-002", "title": "Create or confirm the player character animation setup", "description": "Make sure the player character has the correct skeletal mesh, animation blueprint path, movement references, and folder structure for Phase 1 locomotion work.", "status": "Complete" },
            { "id": "p1-anim-003", "title": "Set up idle, walk, run, sprint, jump, land, and crouch animations", "description": "Focus only on core movement animations needed for testing the player foundation. Combat, weapon handling, and cinematic animation should stay out of this phase.", "status": "Complete" },
            { "id": "p1-anim-004", "title": "Connect animation blueprint to BP_PlayerSurvivorCharacter", "description": "Wire the animation blueprint into the player survivor character and confirm movement state changes are driving animation transitions correctly.", "status": "Complete" },
            { "id": "p1-anim-005", "title": "Test movement animations in Map_TestSystems", "description": "Use the Phase 1 test map to check idle, walking, running, sprinting, jumping, landing, and crouching in a clean controlled area.", "status": "Complete" },
            { "id": "p1-anim-006", "title": "Keep advanced combat animations for a later phase", "description": "This is an explicit scope guard. Do not build takedowns, weapon combos, finishers, or full combat animation systems until the basic player foundation is stable.", "status": "Complete" }
          ]
        }
      ]
    },
